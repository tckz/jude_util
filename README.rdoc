...
* 以下のツールはJUDE-APIを使用するので、
  環境変数CLASSPATHにjude-pro.jarの所在を設定して実行する
* 実行例：(linux)

   % env CLASSPATH=./jude-pro.jar jruby export_jude.rb 引数・・・
